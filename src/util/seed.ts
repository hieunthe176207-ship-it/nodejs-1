...
export async function seedDatabase() {
  ...
  const [
  ...
  ] = await Event.insertMany([
    {
      ...
      price: 500_000,        // 1 loại vé
      quantity: 2000,        // tổng số vé event này
  ...
  await Booking.insertMany([
    // A – Rock Concert
    {
      ...
      status: "paid",
      quantity: 2,
      unitPrice: 800_000,              // => đã tăng giá / vé VIP chẳng hạn
